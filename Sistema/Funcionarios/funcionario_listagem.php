            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<td>
                                <a href="funcionario_editar.php?codigo=' . $row["id_funcionario"] . '" class="btn btn-warning btn-sm">Editar</a>
                                <a href="funcionario_excluir.php?codigo=' . $row["id_funcionario"] . '" class="btn btn-danger btn-sm">Excluir</a>
                              </td>';
                        echo '</tr>';
                    }
                } else {
